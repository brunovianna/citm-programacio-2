...
// C-style pass by value
void swapBottom(Outfit outfit, std::string newBottom) {
    outfit.bottom = newBottom;
    std::cout << "Inside function: " << outfit.top << ", " << outfit.bottom << ", " << outfit.shoes << std::endl;
}

// C-style pass by refernce
...
int main() {
    ...
    std::cout << "\nTrying to swap shoes (pass by value C):" << std::endl;
    swapBottom(myOutfit, "Skirt");
    std::cout << "After function call: " << myOutfit.top << ", " << myOutfit.bottom << ", " << myOutfit.shoes << std::endl;

    std::cout << "\nTrying to swap shoes (pass by reference C):" << std::endl;
